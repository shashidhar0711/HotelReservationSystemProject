    ...
    public class HotelReservation 
    {
        ...
        public void AddHotel(string customerType)
        {
            try
            {
                ...
                {
                    throw new HotelCustomException("Invalid Customer Type", HotelCustomException.ExceptionType.INVALID_CUSTOMER);
                }
            }
        ...
        public void FindingCheapestHotel(DateTime startingDate, DateTime endingDate, string checkInDay)
        {
            try
            {
                ...
                {
                    throw new HotelCustomException("Invalid date Type", HotelCustomException.ExceptionType.VALID_DATE_FORMAT);
                }
            }
            catch(HotelCustomException exception)
            {
