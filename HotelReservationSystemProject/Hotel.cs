...
namespace HotelReservationSystemProject
{
    public class Hotel
    {
        ...
        public int weekDayRewardsRates;
        public int weekEndRewardsRates;
        ...
        public Hotel(int totalCost, string hotelName, int rating)
        {
        ...
        public Hotel(string hotelName, int weekDayRewardsRates, int weekEndRewardsRates)
        {
            this.hotelName = hotelName;
            this.weekDayRewardsRates = weekDayRewardsRates;
            this.weekEndRewardsRates = weekEndRewardsRates;
        }
